...
/**
 * Domain object for team member search request.
 */
public class TeamMemberSearchRequest {
    ...
    public TeamMemberSearchRequest() {
    }
    
    public TeamMemberSearchRequest(String query, Integer maxResults) {
        this.query = query;
